<template>
  ...
  <div class="flex justify-center w-full h-full">
    <div class="flex flex-col w-4/5 max-w-6wl py-10">
        ...
        <div
        v-else
        class="flex py-3 pl-5 mt-2 rounded justifiy-between items-center bg-brand-gray w-full lg:w-1/2">
        ...
        >
          ...
          <pre v-else>&lt;script src="https://leoeek-feedbacker-widger.netlify.app?api_key={{store.User.currentUser.apiKey}}"&gt;&lt;/script&gt;</pre>
        </div>
...
export default {
  components: {
    ContentLoader, HeaderLogged, Icon
  },
  setup () {
